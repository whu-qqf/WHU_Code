...
void SaveMatrix(int rows, int cols, const double* matrix, const std::string& filename, int width, int precision);
...
void Mat3xMat3(const double M1[], const double M2[], double M3[]);
double modMat(const double M[]);
double detMat3x3(const double M[]);

void QuaxQua(const double q1[], const double q2[], double q3[]);
