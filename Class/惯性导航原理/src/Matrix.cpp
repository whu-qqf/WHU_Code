...
void Mat3xMat3(const double M1[], const double M2[], double M3[])  //三维向量叉乘
{
...
double modMat(const double M[])    //三维向量的模长
{
...
double detMat3x3(const double M[])    //3x3矩阵的行列式
{
    return 0;
}

void QuaxQua(const double q1[], const double q2[], double q3[])    //四元数乘法
{
    double M1[4 * 4] = { q1[0],-q1[1],-q1[2],-q1[3],
    q1[1],q1[0],-q1[3],q1[2],
    q1[2],q1[3],q1[0],-q1[1],
    q1[3],-q1[2],q1[1],q1[0] };
    MatrixMultiply(4, 4, 4, 1, M1, q2, q3);
}

void Antisymmetric_matrix(const double v[], double M[])    // 反对称矩阵
{
    M[0] = M[4] = M[8] = 0.0;
    M[1] = -v[2], M[2] = v[1], M[3] = v[2], M[5] = -v[0], M[6] = -v[1], M[7] = v[0];
}
